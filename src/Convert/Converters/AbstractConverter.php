...
use ImageConvert\Convert\Converters\BaseTraits\AutoQualityTrait;
use ImageConvert\Convert\Converters\BaseTraits\DestinationPreparationTrait;
use ImageConvert\Convert\Converters\BaseTraits\LoggerTrait;
use ImageConvert\Convert\Converters\BaseTraits\OptionsTrait;
use ImageConvert\Convert\Converters\BaseTraits\WarningLoggerTrait;
...
abstract class AbstractConverter
{
    ...
    final public function __construct($source = '', $destination = '', $options = [], $logger = null)
    {
        ...
        if (!isset($this->options['_skip_input_check'])) {
            $this->logLn('ImageConvert ignited', 'bold');
