...
namespace ImageConvert\Convert\Converters\ConverterTraits;
...
trait ExecTrait
{
     ...
     *
     * @throws  ImageConvert\Convert\Exceptions\ConversionFailed\ConverterNotOperational\SystemRequirementsNotMetException
     * @return  void
     */
