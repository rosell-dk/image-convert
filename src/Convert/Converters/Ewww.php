...
class Ewww extends AbstractConverter
{
    ...
    private function getKey()
    {
        ...
        if (defined('IMAGECONVERT_EWWW_API_KEY')) {
            return constant('IMAGECONVERT_EWWW_API_KEY');
        }
        if (!empty(getenv('IMAGECONVERT_EWWW_API_KEY'))) {
            return getenv('IMAGECONVERT_EWWW_API_KEY');
        }
        return false;
    }
    ...
    */
    ...
    public static function getKeyStatus($key)
    {
        ...
        curl_setopt($ch, CURLOPT_USERAGENT, 'ImageConvert');
