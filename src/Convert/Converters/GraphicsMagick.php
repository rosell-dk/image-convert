...
class GraphicsMagick extends AbstractConverter
{
    ...
    {
        if (defined('IMAGECONVERT_GRAPHICSMAGICK_PATH')) {
            return constant('IMAGECONVERT_GRAPHICSMAGICK_PATH');
        }
        if (!empty(getenv('IMAGECONVERT_GRAPHICSMAGICK_PATH'))) {
            return getenv('IMAGECONVERT_GRAPHICSMAGICK_PATH');
        }
        return 'gm';
    }
