...
use ImageConvert\Convert\Converters\ConverterTraits\CloudConverterTrait;
use ImageConvert\Convert\Converters\ConverterTraits\CurlTrait;
...
use ImageConvert\Convert\Exceptions\ConversionFailed\ConverterNotOperational\InvalidApiKeyException;
...
class Wpc extends AbstractConverter
{
    ...
    private function getApiKey()
    {
        ...
        if (defined('IMAGECONVERT_WPC_API_KEY')) {
            return constant('IMAGECONVERT_WPC_API_KEY');
        }
        if (!empty(getenv('IMAGECONVERT_WPC_API_KEY'))) {
            return getenv('IMAGECONVERT_WPC_API_KEY');
        }
        return '';
    }
    ...
    private function getApiUrl()
    {
        ...
        if (defined('IMAGECONVERT_WPC_API_URL')) {
            return constant('IMAGECONVERT_WPC_API_URL');
        }
        if (!empty(getenv('IMAGECONVERT_WPC_API_URL'))) {
            return getenv('IMAGECONVERT_WPC_API_URL');
        }
        return '';
    }
