...
class PathChecker
{
    ...
    public static function checkDestinationPath($destination)
    {
        ...
        if (!preg_match('#\.(webp|png|jpeg|jpg|avif)$#i', $destination)) {
            // Prevent overriding important files.
            // Overriding an .htaccess file would lay down the website.
            throw new InvalidInputException(
                'Destination file must end with a recognized file extension (ie ".webp", "png", etc). ' .
                'If you deliberately want to store the file with another extension, you must rename ' .
