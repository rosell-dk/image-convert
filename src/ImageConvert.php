...
//use ImageConvert\Convert\Converters\ConverterHelper;
use ImageConvert\Convert\Converters\Stack;
//use ImageConvert\Serve\ServeExistingOrHandOver;
use ImageConvert\Convert\ConverterFactory;
use ImageConvert\Options\OptionFactory;
use ImageConvert\Serve\ServeConvertedWebP;
use ImageConvert\Serve\ServeConvertedWebPWithErrorHandling;

/**
 * Convert images and/or serve them.
 *
...
class ImageConvert
{
     ...
     * @param  \ImageConvert\Loggers\BaseLogger $logger (optional)
     *
     * @throws  \ImageConvert\Convert\Exceptions\ConversionFailedException   in case conversion fails
     * @return  void
     */
    public static function convert(string $source, $destination, $options = [], $logger = null)
    {
