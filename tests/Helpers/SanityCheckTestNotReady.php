...
use ImageConvert\Helpers\SanityCheck;
use ImageConvert\Exceptions\SanityException;

use PHPUnit\Framework\TestCase;

/**
 * @coversDefaultClass ImageConvert\Helpers\SanityCheck
 * @covers ImageConvert\Helpers\SanityCheck
 */
