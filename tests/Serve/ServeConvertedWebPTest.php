...
namespace ImageConvert\Tests\Serve;
...
use ImageConvert\Serve\MockedHeader;
use ImageConvert\Serve\Exceptions\ServeFailedException;

use ImageConvert\Tests\CompatibleTestCase;
...
/**
 * @coversDefaultClass ImageConvert\Serve\ServeConvertedWebP
 * @covers ImageConvert\Serve\ServeConvertedWebP
 */
class ServeConvertedWebPTest extends CompatibleTestCase
{
    ...
    public function testServeOriginal()
    {
        ...
        $options = [
            ...
            'convert' => [
                'converters' => [
                    '\\ImageConvert\\Tests\\Convert\\TestConverters\\SuccessGuaranteedConverter'
                ]
            ]
        ];
